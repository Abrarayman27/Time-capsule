...
class maproyal extends StatefulWidget {
  const maproyal({super.key});
...
class _MAPState extends State<maproyal> {
  ...
  static const CameraPosition _center = CameraPosition(
      target: LatLng(31.24082055589539, 29.963284796219074), zoom: 17);
  final List<Marker> _marker = [];
  final List<Marker> _branch = const [
    Marker(
        markerId: MarkerId('1'),
        position: LatLng(31.24082055589539, 29.963284796219074),
