...
class greekphoto2 extends StatefulWidget {
  const greekphoto2({super.key});

  @override
  State<greekphoto2> createState() => greekphoto2State();
}

class greekphoto2State extends State<greekphoto2> {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
        routes: {
          "greekphoto1": (context) => const uni(),
          "greekphoto3": (context) => const greekphoto3(),
          "gold": (context) => gold(),
          "vase": (context) => const vase(),
          "marble": (context) => const marble(),
                        ...
                        Builder(builder: (context) {
                          return Container(
                            ...
                            decoration: const BoxDecoration(
                              ...
                              image: DecorationImage(
                                image: AssetImage("image/p11.jpg"),
                                fit: BoxFit.cover,
                              ),
                            ),
                            child: const Row(
