...
class zenab extends StatefulWidget {
  const zenab({super.key});

  @override
  State<zenab> createState() => zenabState();
}

class zenabState extends State<zenab> {
                        ...
                        Builder(builder: (context) {
                          return Container(
                            ...
                            decoration: const BoxDecoration(
                              ...
                              image: DecorationImage(
                                image:
                                    AssetImage("royalImages/zenabheshamf.jpg"),
                                fit: BoxFit.cover,
                              ),
                            ),
                            child: const Row(
