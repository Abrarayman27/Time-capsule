...
class greekphoto3 extends StatefulWidget {
  const greekphoto3({super.key});

  @override
  State<greekphoto3> createState() => greekphoto3State();
}

class greekphoto3State extends State<greekphoto3> {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
        routes: {
          ...
          "greekphoto2": (context) => const greekphoto2(),
          "gold": (context) => gold(),
